          ...
          <Row
            ...
            <Row flex="1" alignItems="center" justifyContent="flex-end">
              <Block marginRight=".5rem">
                <Copy hasCopied={hasCopied} id="copy" text={html} onCopy={premailCopy} />
              </Block>
              <Block marginRight=".5rem">
              ...
              <Block>
                <Button onClick={() => this.toggleHTML()} small="true">
                  {!showHTML && (
                    <span>
                      <i className="ion ion-code" style={{ marginRight: ".5rem" }} />Show HTML
                    </span>
                  )}
                  {showHTML && (
                    <span>
                      <i className="ion ion-eye" style={{ marginRight: ".5rem" }} />Show Preview
                    </span>
                  )}
                </Button>
              </Block>
