        ...
        >
          <Row>
            ...
            >
              ...
              {card.kind === "html" ? (
                <Code id={card.id} content={card.content} edit={edit} />
              ) : null}
              {card.kind === "text" ? (
                <Text id={card.id} content={card.content} edit={edit} />
              ) : null}
              {card.kind === "heading" ? (
                <Heading id={card.id} content={card.content} edit={edit} />
              ) : null}
            </Block>
